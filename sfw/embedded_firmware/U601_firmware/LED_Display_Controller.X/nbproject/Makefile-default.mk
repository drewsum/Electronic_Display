...
# Source Files
SOURCEFILES=gpio_setup.c heartbeat_timer.c power_saving.c error_handler.c usb_uart.c panel_control.c spi_flash.c esp8266.c adc.c misc_board_control.c rotary_encoder.c external_bus_interface.c terminal_control.c device_control.c cause_of_reset.c 32mz_interrupt_control.c watchdog_timer.c main.c
